...
@section("main")
    ...
    <div class="relative w-full h-[500px] sm:h-[400px] xs:h-[300px]">
        <img src="{{ asset('storage/about_us_baner.jpg') }}" class="w-full h-full object-cover opacity-90">

        <div class="absolute top-1/2 left-16 xs:left-4 sm:left-8 -translate-y-1/2 text-white max-w-[90vw]">
            <h1 class="text-6xl sm:text-4xl xs:text-3xl font-extrabold leading-tight">About Nova Inventory</h1>
            <p class="text-2xl sm:text-xl xs:text-lg mt-3">We are your reliable partner for inventory solutions.</p>
        </div>
    </div>

    <section class="py-20 bg-white">
        <div class="container mx-auto flex flex-col px-6 md:flex-row items-center gap-12">
            <div class="md:w-1/2">
            ...
            <div class="md:w-1/2 flex justify-center">
                <img src="{{ asset('storage/who.jpg') }}" class="rounded-2xl shadow-md w-full md:w-4/5">
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto">
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    @for ($i = 1; $i <= 10; $i++)
                        <div class="swiper-slide bg-gray-300 rounded-lg flex py-50 items-center justify-center text-2xl px-10 py-12 font-semibold text-gray-800">
                            Project {{ $i }}
                        </div>
                    @endfor
                </div>
