...
@section("main")
    ...
    <div class="bg-gray-100 pb-40">
        ...
        <div class="container mx-auto w-[1000px] rounded-xl bg-white">
            <div class="flex items-center justify-between text-white bg-blue-900/95 px-5 py-4 rounded-t-xl"> 
                ...
                <a href="" class="inline-flex items-center justify-center p-1 bg-white/50 rounded-full
                                transition-all duration-300 hover:scale-110 hover:bg-white/70">
            ...
            <div class="flex">
                ...
                <div class="flex flex-col items-start px-5">
                    ...
                    <button type="submit" class="bg-amber-300 px-2 py-1 rounded-xl hover:bg-blue-900/95 hover:text-white">Sure, let's chat</button>
                </div>
            </div>
        </div>


        <div class="container mx-auto w-[1000px] rounded-xl bg-white mt-5 grid grid-cols-3 gap-1">
        ...
        <div class="container mx-auto w-[1000px] rounded-xl bg-white mt-5">
